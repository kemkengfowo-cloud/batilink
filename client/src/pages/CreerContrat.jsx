        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 mt-6 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {form.remunerationTotal > 0 && (
              <div className="bg-blue-50 border-2 border-blue-200 rounded-2xl p-5">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between text-gray-500"><span>Commission Batilink (10%)</span><span>{formatBudget(commission)}</span></div>
            ...
            <div className="bg-amber-50 border-2 border-amber-200 rounded-2xl p-5 text-sm text-amber-800">
              <p className="font-bold mb-2">⚠️ Clause de protection Batilink</p>
              <p>Tout accord ou paiement effectue en dehors de la plateforme Batilink annule automatiquement toute protection et garantie. Batilink ne pourra pas intervenir en cas de litige pour des transactions hors plateforme.</p>
            </div>
