        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {!showForm ? (
                  ...
                  <form onSubmit={postuler} className="space-y-4">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-700">
                      Votre message sera envoye directement a l employeur via la messagerie Batilink.
                    </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-5">
              ...
              <a href={`https://wa.me/?text=Mission%20disponible%20sur%20Batilink%20:%20${encodeURIComponent(mission.titre)}%20-%20www.batilink.org/missions/${mission._id}`}
