    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 p-12">
          <Link to="/" className="flex items-center gap-3"><div className="w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center flex-shrink-0"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M3 10.5L12 3L21 10.5V21H15V15H9V21H3V10.5Z" fill="white"/></svg></div><span className="font-display font-bold text-2xl text-white">BYHOME</span></Link>
        </div>
        <div className="relative z-10 p-12">
