      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl border border-gray-100 p-8 space-y-8">
          {[
            ...
            { titre:'Vos droits', contenu:'Vous avez le droit d\'acceder, modifier et supprimer vos donnees a tout moment depuis votre profil ou en contactant contact@byh-cm.com.' },
            ...
            { titre:'Contact', contenu:'Pour toute question sur vos donnees personnelles, contactez contact@byh-cm.com' },
          ].map(s=>(
            <div key={s.titre}>
