    ...
    <div className="min-h-screen bg-gray-50">
      <div style={{background:'linear-gradient(135deg, #0a1628 0%, #0d2044 100%)'}} className="py-10">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-blue-200">L'admin Batilink selectionne les meilleurs techniciens pour votre chantier</p>
        </div>
      </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li className="flex items-center gap-2"><span className="text-blue-500 font-bold">2.</span> L'admin Batilink selectionne les techniciens disponibles</li>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="bg-amber-50 border-2 border-amber-200 rounded-2xl p-5">
              ...
              <p className="text-amber-700 text-xs mt-2">
                ...
                Batilink prend une commission de 10% sur le montant final.
              </p>
            </div>
